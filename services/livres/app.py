...
# # ============================================
# # 2. GET /api/livres/<id> - Détail d'un livre
# # ============================================
...
# # ============================================
# # 3. POST /api/livres - Ajouter un livre
# # ============================================
...
#     try:
#         cur.execute('''
#             INSERT INTO livres (titre, auteur, isbn, categorie, annee_publication, nombre_exemplaires)
#             VALUES (%s, %s, %s, %s, %s, %s)
#             RETURNING *
#         ''', (
#             data['titre'],
...
# # ============================================
# # 4. PUT /api/livres/<id> - Modifier un livre
# # ============================================
...
# # ============================================
# # 5. DELETE /api/livres/<id> - Supprimer un livre
# # ============================================
...
# # ============================================
# # 6. GET /api/livres/search?q=&type= - Recherche
# # ============================================
# @app.route('/api/livres/search', methods=['GET'])
# def search_livres():
#     query = request.args.get('q', '')
#     search_type = request.args.get('type', 'titre')  # titre, auteur, isbn
...
# # ============================================
# # POST /api/livres/upload - Upload image livre
# # ============================================
