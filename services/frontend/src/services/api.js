...
// //     // Admin factice : admin@dit.sn / admin123
// //     if (email === 'admin@dit.sn' && password === 'admin123') {
// //       return { success: true, user: { nom: 'Admin', prenom: 'DIT', role: 'admin' } };
// //     }
// //     throw new Error('Email ou mot de passe incorrect');
// //   },

// //   // Livres
// //   getLivres: () => fetch(API_BASE.livres).then(r => r.json()),
// //   addLivre: (data) => fetch(API_BASE.livres, {
// //     method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
// //   }).then(r => r.json()),
// //   updateLivre: (id, data) => fetch(`${API_BASE.livres}/${id}`, {
// //     method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
// //   }).then(r => r.json()),
// //   deleteLivre: (id) => fetch(`${API_BASE.livres}/${id}`, { method: 'DELETE' }).then(r => r.json()),

// //   // Utilisateurs
// //   getUtilisateurs: () => fetch(API_BASE.utilisateurs).then(r => r.json()),
// //   addUtilisateur: (data) => fetch(API_BASE.utilisateurs, {
// //     method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data)
// //   }).then(r => r.json()),
// //   deleteUtilisateur: (id) => fetch(`${API_BASE.utilisateurs}/${id}`, { method: 'DELETE' }).then(r => r.json()),

// //   // Emprunts
// //   getEmprunts: () => fetch(API_BASE.emprunts).then(r => r.json()),
// //   retournerLivre: (id) => fetch(`${API_BASE.emprunts}/${id}/retour`, { method: 'PUT' }).then(r => r.json()),
// //   exportCSV: () => fetch(`${API_BASE.emprunts}/export`).then(r => r.text()),

// //   // Recommandations
// //   entrainer: () => fetch(`${API_BASE.recommandations}/train`, { method: 'POST' }).then(r => r.json()),
// //   getRecommandations: (userId) => fetch(`${API_BASE.recommandations}/recommandations/${userId}`).then(r => r.json()),
// // };
...
// // Dans l'objet api, ajouter :
// getCategories: () => fetch(API.categories || 'http://localhost:8081/api/categories').then(r => r.json()),
// addCategorie: (data) => fetch('http://localhost:8081/api/categories', { method: 'POST', headers: headers(false), body: JSON.stringify(data) }).then(r => r.json()),
// updateCategorie: (id, data) => fetch(`http://localhost:8081/api/categories/${id}`, { method: 'PUT', headers: headers(false), body: JSON.stringify(data) }).then(r => r.json()),
// deleteCategorie: (id) => fetch(`http://localhost:8081/api/categories/${id}`, { method: 'DELETE' }).then(r => r.json()),
